          ...
          <div class="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                id="email"
                autocomplete="email"
                className="border-2 block w-full rounded-md px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div class="sm:col-span-2">
